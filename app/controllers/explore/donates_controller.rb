module Explore
  class DonatesController < ApplicationController
    ...
    def create
      ...
      return redirect_to new_explore_book_donate_path(@book) unless fee > 0
      ...
      req_params = {
        ...
        trade_type: 'NATIVE',
        notify_url: Rails.application.routes.url_helpers.explore_book_donate_callback_path(@book, order, host: 'zhibimo.com')
      }
      ...
      redirect_to explore_book_donate_path(@book, order)
    end
    ...
    def show
      ...
      return redirect_to explore_book_path(@order.book.slug) unless @order.may_wait?

      result = WxPay::Service.invoke_orderquery({out_trade_no: @order.id})

      if result['trade_state'] == 'SUCCESS'
        @order.done!
        redirect_to explore_book_path(@order.book.slug)
      end
    end
    ...
    def check_book_donate!
      ...
      redirect_to explore_book_path(@book) unless (@book.free? and @book.donate)
    end
  end
end
